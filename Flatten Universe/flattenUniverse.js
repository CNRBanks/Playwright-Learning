...
( async() => {
    ...
    /// open View Reports (NEW)
    await page.click('#Link655', {delay: 100});
    // click ETO Results --- not liking this ID
    await page.click('#rgCustomUniverses_ctl00_ctl04_imgFlattenRequest');
